...
- [The Stall](https://github.com/thebrierfox/the-stall) - Remote MCP server with 207 no-API-key tools: U.S. treasury yields, equity fundamentals, earnings surprises, insider trades (SEC Form 4), FEC political donations, macro indicators (FRED-backed), and crypto/DeFi data. x402 USDC pay-per-call on Base. ![GitHub stars](https://img.shields.io/github/stars/thebrierfox/the-stall?style=flat-square) - One server, eight sources: Alpha Vantage, BLS, Census, FRED, IMF, Nasdaq, OECD, and World Bank. ![GitHub stars](https://img.shields.io/github/stars/gvaibhav/TAM-MCP-Server?style=flat-square)
